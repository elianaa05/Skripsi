	...
	<div class="row product-lists">
		...
		<div class="col-lg-4 col-md-6 text-center strawberry">
			<div class="single-product-item">
				...
				<a href="{{route('tambahbooking')}}" class="cart-btn"><i class="fas fa-calendar"></i> Booking</a><br><br>
				<a href="{{route('baranguser')}}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Belanja</a>
			</div>
		</div>
		@endforeach
	</div>
