        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('barangs')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="BarangJual">Barang Jual</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('barangjual')}}" class="menu-link">
                    <div data-i18n="Daftar Barang">Daftar Barang Jual</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('users')}}" class="menu-link">
                ...
                <div data-i18n="Patokanharga">Patokan Harga</div>
              </a>
            </li>
